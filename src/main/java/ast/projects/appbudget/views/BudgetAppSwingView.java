	...
	public BudgetAppSwingView() {
		...
		DocumentListener btnUserEnabler = new DocumentListener() {
		    private void updateButtonState() {
		    	...
		    	boolean areUserFieldsValid = TextFieldsValidatorUtils.validateUserNameTextField(textFieldUserName.getText()) &&
		        ...
		        btnUserModify.setEnabled(listUsers.getSelectedIndex() != -1 && areUserFieldsValid);
		...
		DocumentListener btnBudgetEnabler = new DocumentListener() {
		    private void updateButtonState() {
		    	...
		    	boolean areBudgetFieldsValid = TextFieldsValidatorUtils.validateBudgetTitleTextField(textFieldBudgetTitle.getText()) &&
		        ...
		        btnBudgetModify.setEnabled(listBudgets.getSelectedIndex() != -1 && areBudgetFieldsValid);
		...
		DocumentListener btnExpenseEnabler = new DocumentListener() {
		    private void updateButtonState() {
		    	...
		    	boolean areExpenseFieldValid = TextFieldsValidatorUtils.validateExpenseItemTitleTextField(textFieldExpenseItemTitle.getText()) &&
			            TextFieldsValidatorUtils.validateExpenseItemAmountTextField(textFieldExpenseItemAmount.getText());
		    	
		    	boolean isAListExpenseSelected = listSavings.getSelectedIndex() != -1 || listWants.getSelectedIndex() != -1
						|| listNeeds.getSelectedIndex() != -1;
		    	
		        btnExpenseAdd.setEnabled(areExpenseFieldValid);
		        btnExpenseModify.setEnabled(areExpenseFieldValid && isAListExpenseSelected);
		        setMessageExpenseFields(areExpenseFieldValid);
