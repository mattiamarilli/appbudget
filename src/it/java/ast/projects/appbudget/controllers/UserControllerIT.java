...
public class UserControllerIT {
	...
	public void setup() {
		...
		factory = new Configuration().setProperty("hibernate.dialect", HIBERNATE_DIALECT)
				...
				.setProperty("hibernate.show_sql", HIBERNATE_SHOW_SQL).addAnnotatedClass(User.class)
				.buildSessionFactory();
	...
	public void testNewUser() {
		...
		verify(view).refreshUsersList(argThat(
				users -> users.size() == 1 && users.get(0).getId() == 1 && users.get(0).getName().equals(TEST_USER_NAME)
